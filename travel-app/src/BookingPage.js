...
const BookingPage = () => {
 ...
 const fetchGuides = async () => {
  try {
    ...
    console.log("Unavailable guide IDs:", unavailableGuideIds); // Debug log

    const availableGuides = allGuides.filter(
      (guide) => !unavailableGuideIds.includes(guide.guide_id)
    );

    console.log("Available guides:", availableGuides); // Debug log
  ...
  setGuideDetailsVisible(guideDetailsVisible === guideId ? null : guideId);
};
      ...
      {showGuideModal && (
        <div className="modal-overlay">
          <div className="modal-contents">
            ...
            {console.log('Rendering guides:', guides)}
              {showGuideModal && (
  <div className="modal-overlay">
    <div className="modal-contents">
      <h2>Select a Local Guide</h2>
      ...
      <div className="guide-list">
        {guides.length > 0 ? guides.map((guide) => (
          <div key={guide.guide_id} className="guide-card">
            ...
            <div>
  <button className="details-btn" onClick={() => toggleGuideDetails(guide.guide_id)}>
    {guideDetailsVisible === guide.guide_id ? "Hide Details" : "Details"}
  </button>
